...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1f7efe;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(95000000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "limna";
